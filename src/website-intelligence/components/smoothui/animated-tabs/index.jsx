...
function AnimatedTabs({
  ...
  const getTabStyles = (isActive) => cn(
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              ...
              tab.icon ? /* @__PURE__ */ jsx("span", { className: "relative z-10", children: tab.icon }) : null,
