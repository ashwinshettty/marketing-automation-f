  ...
  "relative inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap font-medium outline-none ring-offset-background transition-[transform,background-color,border-color,color,box-shadow] duration-150 ease-out focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 active:scale-[0.97] disabled:pointer-events-none disabled:opacity-50 motion-reduce:transition-none motion-reduce:active:scale-100 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    variants: {
      color: {
        ...
        destructive: "[--btn-fg:#fff] [--btn-hover:color-mix(in_oklab,var(--color-destructive)_85%,black)] [--btn:var(--color-destructive)]",
        green: "[--btn-fg:var(--color-green-fg)] [--btn-hover:var(--color-green-hover)] [--btn:var(--color-green)]",
        neutral: "[--btn-fg:var(--color-background)] [--btn-hover:var(--color-smooth-900)] [--btn:var(--color-foreground)]"
      },
      shape: {
        default: "",
        pill: "rounded-full!",
      ...
      variant: {
        ...
        outline: "border border-transparent bg-background text-[var(--btn,var(--color-foreground))] shadow-black/15 shadow-sm ring-1 ring-foreground/10 hover:bg-primary dark:ring-foreground/15",
...
function SmoothButton({
  ...
  if (asChild) {
    return /* @__PURE__ */ jsx(Slot, { className: classes, ref, ...props, children });
  }
  const setRefs = (node) => {
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx(AnimatePresence, { initial: false, children: loading ? /* @__PURE__ */ jsx(
          motion.span,
          {
            animate: { marginRight: "0.5rem", opacity: 1, width: "1em" },
            className: "inline-flex shrink-0 items-center justify-center overflow-hidden",
            exit: { marginRight: 0, opacity: 0, width: 0 },
            initial: shouldReduceMotion ? { marginRight: "0.5rem", opacity: 1, width: "1em" } : { marginRight: 0, opacity: 0, width: 0 },
            transition: shouldReduceMotion ? { duration: 0 } : { bounce: 0.1, duration: 0.25, type: "spring" },
...
var stdin_default = SmoothButton;
export {
