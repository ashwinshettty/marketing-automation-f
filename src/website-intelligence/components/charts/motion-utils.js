...
function springOptionsFromTransition(transition, fallback = { stiffness: 60, damping: 20 }) {
  if (!transition) {
    return fallback;
  }
  if (transition.type === "spring") {
    const bounce = typeof transition.bounce === "number" ? transition.bounce : void 0;
