...
function PieProvider({
  ...
  return /* @__PURE__ */ jsx(PieStableContext.Provider, { value: stable, children: /* @__PURE__ */ jsx(PieHoverContext.Provider, { value: hover, children }) });
}
...
var stdin_default = PieStableContext;
export {
  PieProvider,
