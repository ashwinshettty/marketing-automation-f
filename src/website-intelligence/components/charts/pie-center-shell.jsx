...
function PieCenterShell({
  ...
  return /* @__PURE__ */ jsx(PieProvider, { value: contextValue, children: /* @__PURE__ */ jsx(PieCenter, { ...pieCenterProps }) });
}
