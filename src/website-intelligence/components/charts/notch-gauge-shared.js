...
function collectGaugeDefsElements(nodes) {
  const out = [];
...
function interpolateGaugeHex(color1, color2, factor) {
...
function createNotchPath(points, cornerRadiusPx, verticalDepth) {
...
function resolveGaugeBgFill(options) {
  const {
    notchIndex,
    totalNotches,
    hasCustomInactive,
...
function resolveGaugeActiveFill(options) {
  const {
    notch,
    hasCustomActive,
    activeFill,
